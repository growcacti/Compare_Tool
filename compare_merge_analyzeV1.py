...
class CodeComparatorApp:
    ...
    def create_widgets(self):
        ...
        ttk.Button(btn_frame, text="Load Code 1", command=lambda: self.load_file(self.text1)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Load Code 2", command=lambda: self.load_file(self.text2)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Compare Code", command=self.compare_code).pack(side=tk.LEFT, padx=5)
...
class SemanticDeduplicationApp:
    ...
    def create_widgets(self):
        ...
        ttk.Button(btn_frame, text="Load Code 1", command=lambda: self.load_file(self.text1)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Load Code 2", command=lambda: self.load_file(self.text2)).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Find Duplicates", command=self.find_duplicates).pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Save Merged Code", command=self.save_merged_code).pack(side=tk.LEFT, padx=5)
